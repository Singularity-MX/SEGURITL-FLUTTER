...
class AgregarUsuarios extends StatefulWidget {
  @override
  _AgregarUsuariosState createState() => _AgregarUsuariosState();
}
  ...
  Future<void> addUser(String formData) async {
    ...
    try {
      final response = await http.post(
        Uri.parse(backendUrl + '/api/users/add'),
        headers: {
      ...
      final String userId = userData['id'];
          ...
          if (userType == 'Guardia') {
            ...
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => AgregarInfoGuardia(userId: userId)),
            );
          } else {
            // Usuario tipo administrador: Navegar a la pantalla AdminScreen
            Navigator.push(
              context,
