  ...
  Future<void> getHomeInfo() async {
    try {
      final response = await http.get(
          Uri.parse(ApiConfig.backendUrl + '/api/Module4/GetGlucoseReadingsLast'));
...
Positioned(
  top: 50,
  left: MediaQuery.of(context).size.width * 0.025, // Mover el contenedor al centro
  right: MediaQuery.of(context).size.width * 0.025, // Mover el contenedor al centro
  child: Container(
    width: MediaQuery.of(context).size.width * 0.95, // Ancho del 95% de la pantalla
    height: 60,
    decoration: BoxDecoration(
      color: Color.fromARGB(66, 0, 0, 0), // Color de fondo con 20% de opacidad
    ...
    child: ClipRRect(
      ...
      child: BackdropFilter(
        filter: ImageFilter.blur(sigmaX: 10.0, sigmaY: 10.0), // Aplicar efecto de desenfoque
        child: Row(
      ...
      child: BackdropFilter(
        ...
        child: Row(
          ...
          children: [
            ...
            Text(
              info.isNotEmpty ?  '${info[0]['AID']} (${info[0]['Duration']} min)': 'No data',
      ...
      child: BackdropFilter(
        ...
        child: Row(
          ...
          children: [
            ...
            Text(
              info.isNotEmpty ?   '${info[0]['FID']} (${info[0]['Cantidad']} gr.)' : 'No data',
...
Wrap(
  alignment: WrapAlignment.center, // Alinea las filas en el centro
  spacing: 13.0, // Espaciado entre las tarjetas
  children: [
    CardWithImageAndText('lib/assets/ICONS_CARD/glucosaIcon.png', 'Glucosa',  140, 140,70, 70,() {
    Navigator.of(context).push(MaterialPageRoute(
      builder: (context) {
    ...
    CardWithImageAndText('lib/assets/ICONS_CARD/comidasIcon.png', 'Alimentos',   140, 140,70, 70, () {
    Navigator.of(context).push(MaterialPageRoute(
      builder: (context) {
...
Wrap(
  ...
  spacing: 13.0, // Espaciado entre las tarjetas
  children: [
    CardWithImageAndText('lib/assets/ICONS_CARD/actividadesIcon.png', 'Actividades',140, 140,70, 70, () {
    Navigator.of(context).push(MaterialPageRoute(
      builder: (context) {
    ...
    CardWithImageAndText('lib/assets/ICONS_CARD/statsIcon.png', 'Estadísticas',140, 140,70, 70,
    () {
    Navigator.of(context).push(MaterialPageRoute(
      builder: (context) {
        return GlucoseChartScreen(); // Reemplaza Pantalla1 con la pantalla que deseas abrir.
      },
    ));
  },)
  ],
...
class CardWithImageAndText extends StatelessWidget {
  ...
  CardWithImageAndText(this.imagePath, this.cardText, this.cardWidth, this.cardHeight, this.imageWidth, this.imageHeight, this.onTap);
